...
# start project for development
 - run the docker image: `docker run -it --rm --shm-size=8g --env-file .env --gpus all --mount type=bind,src=./yasha,dst=/yasha/yasha --mount type=bind,src=./start.py,dst=/yasha/start.py --mount type=bind,src=./config,dst=/yasha/config  -p 8265:8265 -p 8000:8000 -p 8081:8080 yasha`
